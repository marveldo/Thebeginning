"""
Django settings for TheBeginning project.
...
SECRET_KEY = 'django-insecure-h(^==6w14e@l(f%p=9(x(b=rhbrm#rh4ow*t%egdgo7qq!5t2k'
...
WSGI_APPLICATION = 'TheBeginning.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'obpvuqzxushsvttq'
...
AWS_ACCESS_KEY_ID = 'AKIAYED7L3CRKMA3UZGJ'
